...
/*
 * This is an example of PaynetEasy bank payout v4 API usage.
 *
...
$params = array(
        'client-order-id' => 'bank-payout-' . uniqid(),
	'amount' => '100',
	'currency' => 'USD',
        'order_desc' => 'Payout to bank',
        'account_number' => '123412341234',
        'bank_name' => 'Cool bank',
        'bank_branch' => 'Branch 1',
        'bank_province' => 'Some province',
        'bank_city' => 'Bank city'
);

$status = $oauth->request('POST', "https://$serverHost/paynet/api/v4/payout/$endpointId", $params);
//echo($status . "\n");
